...
const KakaoLogin = ({navigation: {navigate}}) => {
  const parseAuthCode = async url => {
    ...
    if (startIndex !== -1) {
      ...
      await axios
        .post('http://172.30.1.18:3000/oauth/kakao/callback', {
          params: {
            code: authCode,
          },
        })
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <WebView
        ...
        style={{marginTop: 30}}
        source={{
          uri: 'https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=1c1252b4d425329642c458690fe99854&redirect_uri=http://172.30.1.18:3000/oauth/kakao/callback',
        }}
